                ...
                calendar1.fullCalendar({
                    ...
                    dayClick: function (date, jsEvent, view) {
                        ...
                        if (!isSelected) {
                            ...
                            var event = calendar1.fullCalendar('clientEvents', eventId);
                            if (event) {
                    ...
                    eventClick: function (calEvent, jsEvent, view) {
                        ...
                        var cellElement = $('td[data-date="' + eventDate + '"]');
    ...
    calendar.fullCalendar({
        ...
        dayClick: function (date, jsEvent, view) {
            ...
            if (!isSelected) {
                ...
                // Thêm ngày vào Session Storage
                sessionStorage.setItem('selectedDate', JSON.stringify(selectedDates));
